...
class Model(torch.nn.Module):
    def __init__(self, l1_size=16):
        super().__init__()
        self.mrf1 = MRFTree(input_size=5, output_size=l1_size, mrf_prev=False, input=True)
        self.mrf2 = MRFTree(input_size=l1_size, output_size=1, mrf_prev=True, output=True)
